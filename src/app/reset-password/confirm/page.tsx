//C:\admin-panel\src\app\reset-password\confirm\page.tsx
"use client";
...
const api_url =
  process.env.NEXT_PUBLIC_STRAPI_URL || "https://api.itfolkstech.com"; // Ajuste a URL da API conforme necessário
...
function ResetPasswordConfirmPage() {
  ...
  const handleReset = async (e: React.FormEvent) => {
    e.preventDefault();
    setError(null);
    // 1. Loga o que será enviado
    console.log("Body enviado para reset:", {
      code,
      password,
    ...
    try {
      ...
      if (err instanceof Error) {
        setError(
          err.message || "Erro ao redefinir senha, solicite um novo link."
        );
      } else {
